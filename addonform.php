      ...
      <!-- <div class="box-container"> -->
        <div class="form-columns" style="margin-bottom: 0%;">
            <div class="form-group">
               ...
               <input type="text" style="width: 53%; color: green;" id="controlNumber" name="ctrlNum" value="ROX--CDO-RC-<?php echo '-00'.$nextControlNumber ?>" readonly>
...
function generateControlNumber() {
    ...
    var controlNumber = 'ROX-' + year + '-CDO-RC-' + month + '-00'+ ctrl_num;
