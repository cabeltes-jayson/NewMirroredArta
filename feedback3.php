...
if (isset($_POST['submitt'])) {
    ...
    if ($count > 0) {
        ...
        $sql_insert = "INSERT INTO `offline`(`controlNumber`, `ctrl_num`, `client`, `date`, `gender`, `age`, `region`, `service`, `office`, `service_provided`, `numbers_of_transactions`, `other_service`, `c`, `cc`, `ccc`, `sqd`, `sqd_one`, `sqd_two`, `sqd_three`, `sqd_four`, `sqd_five`, `sqd_six`, `sqd_seven`, `sqd_eight`, `suggestion`, `email`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        $stmt_insert = $conn->prepare($sql_insert);
        $stmt_insert->bind_param("ssssssssssssssssssssssssss", $controlNum, $ctrl_num, $client, $currentDate, $gender, $age, $region, $service, $office, $service_provided, $number_of_transactions, $otherservice, $c, $cc, $ccc, $sqd, $sqd_one, $sqd_two, $sqd_three, $sqd_four, $sqd_five, $sqd_six, $sqd_seven, $sqd_eight, $suggestion, $email);
