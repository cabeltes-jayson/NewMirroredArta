...
date_default_timezone_set("Asia/Manila");
 $dsp_date = date("F Y ");
 $filename="CDOFO_".$dsp_date." REGISTRTY OF ESTABLISHMENTS (RULE 1020)";
                // print_r($fetch_attendance);
header("Content-type: application/octet-stream");
header("Content-Disposition: attachment; filename=".$filename.".xls");
header("Pragma: no-cache");
header("Expires: 0");
 $sql_livelihoodtotal = "SELECT COUNT(*) AS grandtotalLivelihood FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%'";
...
<body>
        ...
        <table class="head-tbl">
            ...
            <tr>
                ...
                <td><b> : </td>
                <td colspan="8"><b>REGISTRTY OF ESTABLISHMENTS (RULE 1020)</td>
                <td colspan="64"></td>
                <td colspan="2"></td>
            </tr>
        </table>
...
<?php 
        $select_sale = $conn->query("SELECT * FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' ");
...
#////////////////////////////////////////////////////////..........SQD7
    ...
    $sql_livelihood_citizen = "SELECT COUNT(*) AS totalLivelihoodCitizen FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND client = 'Citizen'";
          $result = $conn->query($sql_livelihood_citizen); 
          $fetch = mysqli_fetch_assoc($result);
          $dsp = $fetch['totalLivelihoodCitizen'];
          

         $sql_livelihood_business = "SELECT COUNT(*) AS totalLivelihoodBusiness FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND client = 'Business'";
          $result00 = $conn->query($sql_livelihood_business); 
          $fetch00 = mysqli_fetch_assoc($result00);
          $dsp00 = $fetch00['totalLivelihoodBusiness'];

         $sql_livelihood_government = "SELECT COUNT(*) AS totalLivelihoodGovernment FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND client = 'Government'";
          $result0 = $conn->query($sql_livelihood_government); 
          $fetch0 = mysqli_fetch_assoc($result0);
          $dsp0 = $fetch0['totalLivelihoodGovernment'];


        $sql_male = "SELECT COUNT(*) AS male_clients FROM poll WHERE date LIKE '%$month%' AND gender = 'Male' AND service LIKE '%4.%'";
        ...
        $dsp_male = $fetch_male_result['male_clients'];
          ...
          $sql_female = "SELECT COUNT(*) AS female_clients FROM poll WHERE date LIKE '%$month%' AND gender = 'Female' AND service LIKE '%4.%'";
          ...
          $sql_noresponse = "SELECT COUNT(*) AS gendnoresponse_clients FROM poll WHERE date LIKE '%$month%' AND gender = '' AND service LIKE '%4.%'";
...
#=============================================================
          ...
          $sql_age0 = "SELECT COUNT(*) AS age0 FROM poll WHERE date LIKE '%$month%' AND age = '24' AND service LIKE '%4.%' ";
          ...
          $sql_age1 = "SELECT COUNT(*) AS age1 FROM poll WHERE date LIKE '%$month%' AND age = '25' AND service LIKE '%4.%'";
          ...
          $sql_age2 = "SELECT COUNT(*) AS age2 FROM poll WHERE date LIKE '%$month%' AND age = '35' AND service LIKE '%4.%' ";
          ...
          $sql_age3 = "SELECT COUNT(*) AS age3 FROM poll WHERE date LIKE '%$month%' AND age = '45' AND service LIKE '%4.%' ";
          ...
          $sql_age4 = "SELECT COUNT(*) AS age4 FROM poll WHERE date LIKE '%$month%' AND age = '55' AND service LIKE '%4.%' ";
          ...
          $sql_age5 = "SELECT COUNT(*) AS age5 FROM poll WHERE date LIKE '%$month%' AND age = '64' AND service LIKE '%4.%'";
          ...
          $sql_noage = "SELECT COUNT(*) AS noage FROM poll WHERE date LIKE '%$month%' AND age = ' ' AND service LIKE '%4.%' ";
...
$sql_lh_c1A = mysqli_query($conn, "SELECT COUNT(*) AS lh_c1A FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND c =1 ");
$rowC1A = mysqli_fetch_assoc($sql_lh_c1A);
$totalLivelihoodC1A = $rowC1A['lh_c1A'];

$sql_lh_c1B = mysqli_query($conn, "SELECT COUNT(*) AS lh_c1B FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND c =2 ");
$rowC1B = mysqli_fetch_assoc($sql_lh_c1B);
$totalLivelihoodC1B = $rowC1B['lh_c1B'];

$sql_lh_c1C = mysqli_query($conn, "SELECT COUNT(*) AS lh_c1C FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND c =3 ");
$rowC1C = mysqli_fetch_assoc($sql_lh_c1C);
$totalLivelihoodC1C = $rowC1C['lh_c1C'];

$sql_lh_c1D = mysqli_query($conn, "SELECT COUNT(*) AS lh_c1D FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND c =4 ");
...
$sql_lh_c2A = mysqli_query($conn, "SELECT 
    ...
    FROM poll WHERE date LIKE '%$month%' AND  service LIKE '%4.%'");
...
$sql_lh_c1no = mysqli_query($conn, "SELECT COUNT(*) AS no1 FROM poll WHERE date LIKE '%$month%' AND service LIKE '%4.%' AND c =' ' ");
