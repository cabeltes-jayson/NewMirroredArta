     ...
     <div class="content">
             ...
             <div class="row">
                <div class="col-12">
                  <div class="card-header">
                    <center>
                      <h2>TABULATION OF SURVEY RESPONSES FOR RULE 1020</h2>
                      <hr>
      ...
      <br>
                  ...
                  if (isset($_POST['search'])) {
                      // Prepare base query
                      $sql_search = "SELECT * FROM poll WHERE service = '4.'";
                  ...
                  ###########################################################################################
                        ...
                        $sql = mysqli_query($conn, "SELECT * from poll WHERE service = '4.' AND date LIKE '%$month%' ORDER BY date DESC");
                        if($sql->num_rows > 0){
                        ...
                        <div class="export-btn mt-3">
                          <a href="functions/downloadRULE1020.php" id="exportLink">
      ...
      document.getElementById('exportButton').addEventListener('click', function(event) {
          ...
          Swal.fire({
              ...
              if (result.isConfirmed) {
                ...
                window.location.href = 'functions/downloadRULE1020.php'; 
